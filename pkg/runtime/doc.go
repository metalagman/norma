...
//   - acpagent for deprecated compatibility aliases to github.com/normahq/go-adk-acpagent/v2
...
//
// Use [github.com/normahq/norma/pkg/runtime/agentfactory] when applications want the
