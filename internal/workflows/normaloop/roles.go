...
func (r *planRole) MapRequest(req AgentRequest) (any, error) {
	...
	return &plan.PlanRequest{
		...
		Paths: &plan.PlanPaths{WorkspaceDir: req.Paths.WorkspaceDir, WorkspaceMode: req.Paths.WorkspaceMode, RunDir: req.Paths.RunDir, CodeRoot: req.Paths.CodeRoot},
...
func (r *doRole) MapRequest(req AgentRequest) (any, error) {
	...
	return &do.DoRequest{
		...
		Paths: &do.DoPaths{WorkspaceDir: req.Paths.WorkspaceDir, WorkspaceMode: req.Paths.WorkspaceMode, RunDir: req.Paths.RunDir, CodeRoot: req.Paths.CodeRoot},
...
func (r *checkRole) MapRequest(req AgentRequest) (any, error) {
	...
	return &check.CheckRequest{
		...
		Paths: &check.CheckPaths{WorkspaceDir: req.Paths.WorkspaceDir, WorkspaceMode: req.Paths.WorkspaceMode, RunDir: req.Paths.RunDir, CodeRoot: req.Paths.CodeRoot},
...
func (r *actRole) MapRequest(req AgentRequest) (any, error) {
	...
	return &act.ActRequest{
		...
		Paths: &act.ActPaths{WorkspaceDir: req.Paths.WorkspaceDir, WorkspaceMode: req.Paths.WorkspaceMode, RunDir: req.Paths.RunDir, CodeRoot: req.Paths.CodeRoot},
