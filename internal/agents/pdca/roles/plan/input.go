...
type BaselineAcceptanceCriterion struct {
	Id          string   `json:"id"`
...
// Task
type Task struct {
	AcceptanceCriteria []BaselineAcceptanceCriterion `json:"acceptance_criteria"`
	Goal               string                        `json:"goal"`
	Id                 string                        `json:"id"`
}

func (strct *BaselineAcceptanceCriterion) MarshalJSON() ([]byte, error) {
...
func (strct *BaselineAcceptanceCriterion) UnmarshalJSON(b []byte) error {
	idReceived := false
	textReceived := false
	verify_hintsReceived := false
	...
	// check if verify_hints (a required property) was received
	if !verify_hintsReceived {
		return errors.New("\"verify_hints\" is required but was not present")
	}
	return nil
}
